...
const Points = () => {
  ...
  useEffect(() => {
    async function loadPosition() {
      ...
      if (status !== 'granted') {
        return Alert.alert('Ooooops...', 'Precisamos de sua permissao para obter a localizacao')
      }
  ...
  useEffect(() => {
    api.get('items').then((response: ItemsResponse) => {
